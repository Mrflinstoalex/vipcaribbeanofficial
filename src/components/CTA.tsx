...
const CTA = ({ data }: { data: CTAProps }) => {
  ...
  return (
    <section
      id="contacto"
      className="py-20 lg:py-28 text-background relative overflow-hidden bg-gradient-to-br from-[hsl(220,50%,10%)] via-[hsl(215,45%,8%)] to-[hsl(0,0%,5%)]"
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-0 left-0 w-96 h-96 bg-ocean rounded-full blur-3xl" />
