  ...
  return (
    <main className="pb-16">
      ...
      <section className="relative">
        <div className="mt-24 aspect-[21/9] md:aspect-[3/1] overflow-hidden">
          <img
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 grid lg:grid-cols-3 gap-8">
          ...
          <article className="lg:col-span-2 bg-card p-8 rounded-2xl border">
            <div
              className="prose prose-lg max-w-none prose-headings:text-foreground prose-headings:font-bold prose-p:text-muted-foreground prose-a:text-inherit prose-a:no-underline prose-strong:text-foreground"
