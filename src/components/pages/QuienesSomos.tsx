          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div
                  className="space-y-4 text-muted-foreground [&_p]:mb-4 [&_h2]:text-foreground [&_h2]:font-bold [&_h2]:text-xl [&_h2]:mt-6 [&_h3]:text-foreground [&_h3]:font-bold [&_h3]:text-lg [&_h3]:mt-6 [&_h4]:text-foreground [&_h4]:font-semibold [&_h4]:mt-4 [&_a]:text-inherit [&_a]:no-underline"
