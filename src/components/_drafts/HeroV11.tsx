  ...
  return (
    <section id="hero" className="relative bg-navy overflow-hidden min-h-screen">
      ...
      >
        ...
        <div className="absolute top-10 right-8 bg-white rounded-2xl
      ...
      <div className="relative z-10 flex flex-col justify-center w-full lg:w-[50%] xl:w-[47%]
        ...
        {/* Ocean accent left border */}
        <div className="absolute left-0 top-0 bottom-0 w-1 bg-ocean hidden lg:block" />
